...
const signQuestions: QuizQuestion[] = [
  ...
  { id: 'sign-au-give-way', prompt: 'Which country uses this give way sign?', image: '/images/external/Australia_road_sign_R1-2.png', answer: 'Australia', distractors: ['New Zealand', 'UK', 'South Africa'], category: 'sign' },
